...
import { EditStoreComponent } from './modals/edit.store.component';
...
export class StoreComponent extends GridComponent implements OnInit {
  ...
  protected read(filter: any) {
    return this.httpService.store.read(filter);
  }
  ...
  protected count(filter: any) {
    return this.httpService.store.count(filter);
  }
  ...
  protected delete(ids: any) {
    return this.httpService.store.delete(ids);
  }
