...
import { EditSakila_categoryComponent } from './modals/edit.sakila_category.component';
 ...
 */
@Component({
  selector: 'app-sakila_category',
  templateUrl: './sakila_category.component.html',
  styleUrls: ['./sakila_category.component.scss'],
  animations: [
...
export class Sakila_categoryComponent extends GridComponent implements OnInit {
   ...
   */
  public url() {
    return 'magic/modules/sakila/category';
  }
  ...
  protected read(filter: any) {
    return this.httpService.sakila_category.read(filter);
  }
  ...
  protected count(filter: any) {
    return this.httpService.sakila_category.count(filter);
  }
  ...
  protected delete(ids: any) {
    return this.httpService.sakila_category.delete(ids);
  }
  ...
  public ngOnInit() {
     ...
     * on our columns.
     */
    this.name = this.createFormControl('category.name.like');
    this.last_update = this.createFormControl('category.last_update.eq');
    this.category_id = this.createFormControl('category.category_id.eq');
  }
  ...
  public editEntity(entity: any) {
    ...
    const dialogRef = this.dialog.open(EditSakila_categoryComponent, {
