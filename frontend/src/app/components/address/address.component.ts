...
import { AddressEditModalComponent } from './modals/address-edit-modal';
...
export class AddressComponent implements OnInit {
  ...
  private displayedColumns: string[] = ['address', 'address2', 'district', 'city_id', 'postal_code', 'phone', 'location', 'last_update', 'delete-instance'];
  ...
  private address_id: FormControl;
  private address: FormControl;
  private address2: FormControl;
  private district: FormControl;
  private city_id: FormControl;
  private postal_code: FormControl;
  ...
  ngOnInit() {
    ...
    this.address_id = new FormControl('');
    this.address_id.valueChanges
      .pipe(debounceTime(this.debounce), distinctUntilChanged())
      .subscribe(query => {
        this.paginator.pageIndex = 0;
        this.filter.offset = 0;
        this.hasFiltered = true;
        this.filter['address_id.eq'] = this.address_id.value;
        this.getData();
      });
    ...
    this.address.valueChanges
      ...
      .subscribe(query => {
        ...
        this.filter.offset = 0;
        this.hasFiltered = true;
        this.filter['address.eq'] = this.address.value;
        this.getData();
      });
    this.address2 = new FormControl('');
    this.address2.valueChanges
      .pipe(debounceTime(this.debounce), distinctUntilChanged())
      .subscribe(query => {
        this.paginator.pageIndex = 0;
        this.filter.offset = 0;
        this.hasFiltered = true;
        this.filter['address2.eq'] = this.address2.value;
        this.getData();
      });
    ...
    this.district.valueChanges
      ...
      .subscribe(query => {
        ...
        this.filter.offset = 0;
        this.hasFiltered = true;
        this.filter['district.eq'] = this.district.value;
        this.getData();
      });
    this.city_id = new FormControl('');
    this.city_id.valueChanges
      .pipe(debounceTime(this.debounce), distinctUntilChanged())
      .subscribe(query => {
        this.paginator.pageIndex = 0;
        this.filter.offset = 0;
        this.hasFiltered = true;
        this.filter['city_id.eq'] = this.city_id.value;
        this.getData();
      });
    this.postal_code = new FormControl('');
    this.postal_code.valueChanges
      .pipe(debounceTime(this.debounce), distinctUntilChanged())
      .subscribe(query => {
        this.paginator.pageIndex = 0;
        this.filter.offset = 0;
        this.hasFiltered = true;
        this.filter['postal_code.eq'] = this.postal_code.value;
        this.getData();
      });
    ...
    this.phone.valueChanges
      ...
      .subscribe(query => {
        ...
        this.filter.offset = 0;
        this.hasFiltered = true;
        this.filter['phone.eq'] = this.phone.value;
        this.getData();
      });
    ...
    this.location.valueChanges
      ...
      .subscribe(query => {
        ...
        this.filter.offset = 0;
        this.hasFiltered = true;
        this.filter['location.eq'] = this.location.value;
        this.getData();
      });
  ...
  getData(countRecords: boolean = true) {
    ...
    this.httpService.addressGet(this.filter).subscribe(res => {
      this.data = res;
      ...
      if (countRecords) {
        ...
        this.httpService.address_countGet(cloned).subscribe(res2 => {
  ...
  editDetails(entity: any) {
    ...
    const dialogRef = this.dialog.open(AddressEditModalComponent, {
      data
    });
    dialogRef.afterClosed().subscribe(res => {
      if (res !== null && res !== undefined) {
        ...
        this.snackBar.open('address successfully updated', 'Close', {
          duration: 2000,
        });
      }
    });
  ...
  createNewRecord() {
    ...
    dialogRef.afterClosed().subscribe(res => {
      if (res !== null && res !== undefined) {
        ...
        this.getData();
        this.snackBar.open('address item successfully created', 'Close', {
          duration: 2000,
        });
      }
    });
  ...
  delete(entity: any, ids: any) {
    ...
    this.httpService.addressDelete(ids).subscribe(res => {
