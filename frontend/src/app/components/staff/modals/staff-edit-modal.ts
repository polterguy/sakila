 ...
 */
@Component({
  templateUrl: './staff-edit-modal.html',
  styleUrls: ['./staff-edit-modal.scss']
})
export class StaffEditModalComponent {
   ...
   */
  private createColumns: string[] = ['first_name', 'last_name', 'address_id', 'picture', 'email', 'store_id', 'active', 'username', 'last_update'];
  private updateColumns: string[] = ['staff_id', 'first_name', 'last_name', 'address_id', 'picture', 'email', 'store_id', 'active', 'username', 'last_update'];
  ...
  save() {
    ...
    if (this.data.isEdit) {
      ...
      this.service.staffPut(this.data.entity).subscribe(res => {
      ...
      this.service.staffPost(this.data.entity).subscribe(res => {
        this.dialogRef.close(this.data.entity);
