...
import { FilmEditModalComponent } from './modals/film-edit-modal';
...
export class FilmComponent implements OnInit {
  ...
  private displayedColumns: string[] = ['title', 'description', 'release_year', 'language_id', 'original_language_id', 'rental_duration', 'rental_rate', 'length', 'replacement_cost', 'rating', 'special_features', 'last_update', 'delete-instance'];
  ...
  private film_id: FormControl;
  private title: FormControl;
  private description: FormControl;
  private release_year: FormControl;
  private language_id: FormControl;
  private original_language_id: FormControl;
  private rental_duration: FormControl;
  private rental_rate: FormControl;
  private length: FormControl;
  private replacement_cost: FormControl;
  private rating: FormControl;
  private special_features: FormControl;
  ...
  ngOnInit() {
    ...
    this.film_id = new FormControl('');
    this.film_id.valueChanges
      .pipe(debounceTime(this.debounce), distinctUntilChanged())
      .subscribe(query => {
        this.paginator.pageIndex = 0;
        this.filter.offset = 0;
        this.hasFiltered = true;
        this.filter['film_id.eq'] = this.film_id.value;
        this.getData();
      });
    ...
    this.title.valueChanges
      ...
      .subscribe(query => {
        ...
        this.filter.offset = 0;
        this.hasFiltered = true;
        this.filter['title.eq'] = this.title.value;
        this.getData();
      });
    ...
    this.description.valueChanges
      ...
      .subscribe(query => {
        ...
        this.filter.offset = 0;
        this.hasFiltered = true;
        this.filter['description.eq'] = this.description.value;
        this.getData();
      });
    this.release_year = new FormControl('');
    this.release_year.valueChanges
      .pipe(debounceTime(this.debounce), distinctUntilChanged())
      .subscribe(query => {
        this.paginator.pageIndex = 0;
        this.filter.offset = 0;
        this.hasFiltered = true;
        this.filter['release_year.eq'] = this.release_year.value;
        this.getData();
      });
    this.language_id = new FormControl('');
    this.language_id.valueChanges
      .pipe(debounceTime(this.debounce), distinctUntilChanged())
      .subscribe(query => {
        this.paginator.pageIndex = 0;
        this.filter.offset = 0;
        this.hasFiltered = true;
        this.filter['language_id.eq'] = this.language_id.value;
        this.getData();
      });
    this.original_language_id = new FormControl('');
    this.original_language_id.valueChanges
      .pipe(debounceTime(this.debounce), distinctUntilChanged())
      .subscribe(query => {
        this.paginator.pageIndex = 0;
        this.filter.offset = 0;
        this.hasFiltered = true;
        this.filter['original_language_id.eq'] = this.original_language_id.value;
        this.getData();
      });
    this.rental_duration = new FormControl('');
    this.rental_duration.valueChanges
      .pipe(debounceTime(this.debounce), distinctUntilChanged())
      .subscribe(query => {
        this.paginator.pageIndex = 0;
        this.filter.offset = 0;
        this.hasFiltered = true;
        this.filter['rental_duration.eq'] = this.rental_duration.value;
        this.getData();
      });
    this.rental_rate = new FormControl('');
    this.rental_rate.valueChanges
      .pipe(debounceTime(this.debounce), distinctUntilChanged())
      .subscribe(query => {
        this.paginator.pageIndex = 0;
        this.filter.offset = 0;
        this.hasFiltered = true;
        this.filter['rental_rate.eq'] = this.rental_rate.value;
        this.getData();
      });
    ...
    this.length.valueChanges
      ...
      .subscribe(query => {
        ...
        this.filter.offset = 0;
        this.hasFiltered = true;
        this.filter['length.eq'] = this.length.value;
        this.getData();
      });
    this.replacement_cost = new FormControl('');
    this.replacement_cost.valueChanges
      .pipe(debounceTime(this.debounce), distinctUntilChanged())
      .subscribe(query => {
        this.paginator.pageIndex = 0;
        this.filter.offset = 0;
        this.hasFiltered = true;
        this.filter['replacement_cost.eq'] = this.replacement_cost.value;
        this.getData();
      });
    ...
    this.rating.valueChanges
      ...
      .subscribe(query => {
        ...
        this.filter.offset = 0;
        this.hasFiltered = true;
        this.filter['rating.eq'] = this.rating.value;
        this.getData();
      });
    this.special_features = new FormControl('');
    this.special_features.valueChanges
      .pipe(debounceTime(this.debounce), distinctUntilChanged())
      .subscribe(query => {
        this.paginator.pageIndex = 0;
        this.filter.offset = 0;
        this.hasFiltered = true;
        this.filter['special_features.eq'] = this.special_features.value;
        this.getData();
      });
  ...
  getData(countRecords: boolean = true) {
    ...
    this.httpService.filmGet(this.filter).subscribe(res => {
      this.data = res;
      ...
      if (countRecords) {
        ...
        this.httpService.film_countGet(cloned).subscribe(res2 => {
  ...
  editDetails(entity: any) {
    ...
    const dialogRef = this.dialog.open(FilmEditModalComponent, {
      data
    });
    dialogRef.afterClosed().subscribe(res => {
      if (res !== null && res !== undefined) {
        ...
        this.snackBar.open('film successfully updated', 'Close', {
          duration: 2000,
        });
      }
    });
  ...
  createNewRecord() {
    ...
    dialogRef.afterClosed().subscribe(res => {
      if (res !== null && res !== undefined) {
        ...
        this.getData();
        this.snackBar.open('film item successfully created', 'Close', {
          duration: 2000,
        });
      }
    });
  ...
  delete(entity: any, ids: any) {
    ...
    this.httpService.filmDelete(ids).subscribe(res => {
