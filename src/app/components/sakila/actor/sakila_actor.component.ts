...
import { EditSakila_actorComponent } from './modals/edit.sakila_actor.component';
 ...
 */
@Component({
  selector: 'app-sakila_actor',
  templateUrl: './sakila_actor.component.html',
  styleUrls: ['./sakila_actor.component.scss'],
  animations: [
...
export class Sakila_actorComponent extends GridComponent implements OnInit {
  ...
  protected read(filter: any) {
    return this.httpService.sakila_actor.read(filter);
  }
  ...
  protected count(filter: any) {
    return this.httpService.sakila_actor.count(filter);
  }
  ...
  protected delete(ids: any) {
    return this.httpService.sakila_actor.delete(ids);
  }
  ...
  public ngOnInit() {
     ...
     * on our columns.
     */
    this.first_name = this.createFormControl('actor.first_name.like');
    this.last_name = this.createFormControl('actor.last_name.like');
    this.last_update = this.createFormControl('actor.last_update.eq');
    this.actor_id = this.createFormControl('actor.actor_id.eq');
  }
  ...
  public editEntity(entity: any) {
    ...
    const dialogRef = this.dialog.open(EditSakila_actorComponent, {
