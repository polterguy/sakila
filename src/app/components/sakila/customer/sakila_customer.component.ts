...
import { EditSakila_customerComponent } from './modals/edit.sakila_customer.component';
 ...
 */
@Component({
  selector: 'app-sakila_customer',
  templateUrl: './sakila_customer.component.html',
  styleUrls: ['./sakila_customer.component.scss'],
  animations: [
...
export class Sakila_customerComponent extends GridComponent implements OnInit {
  ...
  public create_date: FormControl;
   ...
   */
  public url() {
    return 'magic/modules/sakila/customer';
  }
  ...
  protected read(filter: any) {
    return this.httpService.sakila_customer.read(filter);
  }
  ...
  protected count(filter: any) {
    return this.httpService.sakila_customer.count(filter);
  }
  ...
  protected delete(ids: any) {
    return this.httpService.sakila_customer.delete(ids);
  }
  ...
  public ngOnInit() {
     ...
     * on our columns.
     */
    this.first_name = this.createFormControl('customer.first_name.like');
    this.last_name = this.createFormControl('customer.last_name.like');
    ...
    this.create_date = this.createFormControl('customer.create_date.eq');
    this.last_update = this.createFormControl('customer.last_update.eq');
    this.customer_id = this.createFormControl('customer.customer_id.eq');
    this.store_id = this.createFormControl('customer.store_id.eq');
    this.address_id = this.createFormControl('customer.address_id.eq');
    this.active = this.createFormControl('customer.active.eq');
  }
  ...
  public editEntity(entity: any) {
    ...
    const dialogRef = this.dialog.open(EditSakila_customerComponent, {
