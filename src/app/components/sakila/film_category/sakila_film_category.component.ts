...
import { EditSakila_film_categoryComponent } from './modals/edit.sakila_film_category.component';
 ...
 */
@Component({
  selector: 'app-sakila_film_category',
  templateUrl: './sakila_film_category.component.html',
  styleUrls: ['./sakila_film_category.component.scss'],
  animations: [
...
export class Sakila_film_categoryComponent extends GridComponent implements OnInit {
  ...
  public category_id_name: FormControl;
  public last_update: FormControl;
  public film_id: FormControl;
  public category_id: FormControl;
   ...
   */
  public url() {
    return 'magic/modules/sakila/film_category';
  }
  ...
  protected read(filter: any) {
    return this.httpService.sakila_film_category.read(filter);
  }
  ...
  protected count(filter: any) {
    return this.httpService.sakila_film_category.count(filter);
  }
  ...
  protected delete(ids: any) {
    return this.httpService.sakila_film_category.delete(ids);
  }
  ...
  public ngOnInit() {
    ...
    this.category_id_name = this.createFormControl('category_id.name.like');
    this.last_update = this.createFormControl('film_category.last_update.eq');
    this.film_id = this.createFormControl('film_category.film_id.eq');
    this.category_id = this.createFormControl('film_category.category_id.eq');
  }
  ...
  public editEntity(entity: any) {
    ...
    const dialogRef = this.dialog.open(EditSakila_film_categoryComponent, {
