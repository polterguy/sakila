...
import { EditFilm_categoryComponent } from './modals/edit.film_category.component';
...
export class Film_categoryComponent extends GridComponent implements OnInit {
  ...
  protected read(filter: any) {
    return this.httpService.film_category.read(filter);
  }
  ...
  protected count(filter: any) {
    return this.httpService.film_category.count(filter);
  }
  ...
  protected delete(ids: any) {
    return this.httpService.film_category.delete(ids);
  }
  ...
  public ngOnInit() {
    ...
    this.category_id = this.createFormControl('category_id.eq');
  ...
  public editEntity(entity: any) {
    ...
    const dialogRef = this.dialog.open(EditFilm_categoryComponent, {
