...
import { CustomerEditModalComponent } from './modals/customer-edit-modal';
...
export class CustomerComponent implements OnInit {
  ...
  private displayedColumns: string[] = ['store_id', 'first_name', 'last_name', 'email', 'address_id', 'active', 'create_date', 'last_update', 'delete-instance'];
  ...
  ngOnInit() {
    ...
    this.store_id.valueChanges
      .pipe(debounceTime(this.debounce), distinctUntilChanged())
      .subscribe(query => {
        this.paginator.pageIndex = 0;
        this.filter.offset = 0;
        this.hasFiltered = true;
        this.filter['store_id.eq'] = this.store_id.value;
        this.getData();
      });
    ...
    this.first_name.valueChanges
      ...
      .subscribe(query => {
        ...
        this.filter.offset = 0;
        this.hasFiltered = true;
        this.filter['first_name.eq'] = this.first_name.value;
        this.getData();
      });
    ...
    this.last_name.valueChanges
      ...
      .subscribe(query => {
        ...
        this.filter.offset = 0;
        this.hasFiltered = true;
        this.filter['last_name.eq'] = this.last_name.value;
        this.getData();
      });
    ...
    this.active.valueChanges
      ...
      .subscribe(query => {
        ...
        this.filter.offset = 0;
        this.hasFiltered = true;
        this.filter['active.eq'] = this.active.value;
        this.getData();
      });
    this.create_date = new FormControl('');
    this.create_date.valueChanges
      .pipe(debounceTime(this.debounce), distinctUntilChanged())
      .subscribe(query => {
        this.paginator.pageIndex = 0;
        this.filter.offset = 0;
        this.hasFiltered = true;
        this.filter['create_date.eq'] = this.create_date.value;
        this.getData();
      });
  ...
  getData(countRecords: boolean = true) {
    ...
    this.httpService.customerGet(this.filter).subscribe(res => {
      this.data = res;
      ...
      if (countRecords) {
        ...
        this.httpService.customer_countGet(cloned).subscribe(res2 => {
  ...
  editDetails(entity: any) {
    ...
    dialogRef.afterClosed().subscribe(res => {
      if (res !== null && res !== undefined) {
        ...
        this.snackBar.open('customer successfully updated', 'Close', {
          duration: 2000,
        });
      }
    });
  ...
  createNewRecord() {
    ...
    dialogRef.afterClosed().subscribe(res => {
      if (res !== null && res !== undefined) {
        ...
        this.getData();
        this.snackBar.open('customer item successfully created', 'Close', {
          duration: 2000,
        });
      }
    });
  ...
  delete(entity: any, ids: any) {
    ...
    this.httpService.customerDelete(ids).subscribe(res => {
