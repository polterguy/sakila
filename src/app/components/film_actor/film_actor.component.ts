...
import { EditFilm_actorComponent } from './modals/edit.film_actor.component';
...
export class Film_actorComponent extends GridComponent implements OnInit {
  ...
  protected read(filter: any) {
    return this.httpService.film_actor.read(filter);
  }
  ...
  protected count(filter: any) {
    return this.httpService.film_actor.count(filter);
  }
  ...
  protected delete(ids: any) {
    return this.httpService.film_actor.delete(ids);
  }
  ...
  public editEntity(entity: any) {
    ...
    const dialogRef = this.dialog.open(EditFilm_actorComponent, {
