...
import { EditInventoryComponent } from './modals/edit.inventory.component';
...
export class InventoryComponent extends GridComponent implements OnInit {
  ...
  protected read(filter: any) {
    return this.httpService.inventory.read(filter);
  }
  ...
  protected count(filter: any) {
    return this.httpService.inventory.count(filter);
  }
  ...
  protected delete(ids: any) {
    return this.httpService.inventory.delete(ids);
  }
