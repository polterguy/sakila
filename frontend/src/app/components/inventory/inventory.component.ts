...
import { InventoryEditModalComponent } from './modals/inventory-edit-modal';
...
export class InventoryComponent implements OnInit {
  ...
  private displayedColumns: string[] = ['film_id', 'store_id', 'last_update', 'delete-instance'];
  ...
  getData(countRecords: boolean = true) {
    ...
    this.httpService.inventoryGet(this.filter).subscribe(res => {
      this.data = res;
      ...
      if (countRecords) {
        ...
        this.httpService.inventory_countGet(cloned).subscribe(res2 => {
  ...
  editDetails(entity: any) {
    ...
    const dialogRef = this.dialog.open(InventoryEditModalComponent, {
      data
    });
    dialogRef.afterClosed().subscribe(res => {
      if (res !== null && res !== undefined) {
        ...
        this.snackBar.open('inventory successfully updated', 'Close', {
          duration: 2000,
        });
      }
    });
  ...
  createNewRecord() {
    ...
    dialogRef.afterClosed().subscribe(res => {
      if (res !== null && res !== undefined) {
        ...
        this.getData();
        this.snackBar.open('inventory item successfully created', 'Close', {
          duration: 2000,
        });
      }
    });
  ...
  delete(entity: any, ids: any) {
    ...
    this.httpService.inventoryDelete(ids).subscribe(res => {
