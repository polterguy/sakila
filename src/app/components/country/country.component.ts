...
import { EditCountryComponent } from './modals/edit.country.component';
...
export class CountryComponent extends GridComponent implements OnInit {
  ...
  protected read(filter: any) {
    return this.httpService.country.read(filter);
  }
  ...
  protected count(filter: any) {
    return this.httpService.country.count(filter);
  }
  ...
  protected delete(ids: any) {
    return this.httpService.country.delete(ids);
  }
  ...
  public ngOnInit() {
    ...
    this.country = this.createFormControl('country.like');
