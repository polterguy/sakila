...
export class AddressEditModalComponent {
   ...
   */
  private createColumns: string[] = ['address', 'address2', 'district', 'city_id', 'postal_code', 'phone', 'location', 'last_update'];
  private updateColumns: string[] = ['address_id', 'address', 'address2', 'district', 'city_id', 'postal_code', 'phone', 'location', 'last_update'];

  /*
   * Constructor taking a bunch of services injected using dependency injection.
   */
  constructor(
    public dialogRef: MatDialogRef<AddressEditModalComponent>,
  ...
  save() {
    ...
    if (this.data.isEdit) {
      ...
      this.service.addressPut(this.data.entity).subscribe(res => {
      ...
      this.service.addressPost(this.data.entity).subscribe(res => {
        this.dialogRef.close(this.data.entity);
