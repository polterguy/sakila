 ...
 */
@Component({
  templateUrl: './edit.sakila_rental.component.html'
})
export class EditSakila_rentalComponent extends DialogComponent {

  /**
   * Constructor taking a bunch of services injected using dependency injection.
   */
  constructor(
    public dialogRef: MatDialogRef<EditSakila_rentalComponent>,
  ...
  protected getUpdateMethod() {
    return this.service.sakila_rental.update(this.data.entity);
  }
  /**
   * Returns a reference to the create method, to create new entities.
   */
  protected getCreateMethod() {
    return this.service.sakila_rental.create(this.data.entity);
  }
