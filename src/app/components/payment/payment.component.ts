...
import { EditPaymentComponent } from './modals/edit.payment.component';
...
export class PaymentComponent extends GridComponent implements OnInit {
  ...
  protected read(filter: any) {
    return this.httpService.payment.read(filter);
  }
  ...
  protected count(filter: any) {
    return this.httpService.payment.count(filter);
  }
  ...
  protected delete(ids: any) {
    return this.httpService.payment.delete(ids);
  }
  ...
  public ngOnInit() {
     ...
     * on our columns.
     */
    this.payment_id = this.createFormControl('payment_id.eq');
    ...
    this.amount = this.createFormControl('amount.eq');
    this.payment_date = this.createFormControl('payment_date.eq');
