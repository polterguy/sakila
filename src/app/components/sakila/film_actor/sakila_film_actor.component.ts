...
import { EditSakila_film_actorComponent } from './modals/edit.sakila_film_actor.component';
 ...
 */
@Component({
  selector: 'app-sakila_film_actor',
  templateUrl: './sakila_film_actor.component.html',
  styleUrls: ['./sakila_film_actor.component.scss']
})
export class Sakila_film_actorComponent extends GridComponent implements OnInit {
  ...
  public actor_id_first_name: FormControl;
   ...
   */
  public url() {
    return 'magic/modules/sakila/film_actor';
  }
  ...
  protected read(filter: any) {
    return this.httpService.sakila_film_actor.read(filter);
  }
  ...
  protected count(filter: any) {
    return this.httpService.sakila_film_actor.count(filter);
  }
  ...
  protected delete(ids: any) {
    return this.httpService.sakila_film_actor.delete(ids);
  }
  ...
  public ngOnInit() {
     ...
     * on our columns.
     */
    this.actor_id_first_name = this.createFormControl('actor_id.first_name.like');
    this.film_id_title = this.createFormControl('film_id.title.like');
    this.last_update = this.createFormControl('film_actor.last_update.eq');
    this.actor_id = this.createFormControl('film_actor.actor_id.eq');
    this.film_id = this.createFormControl('film_actor.film_id.eq');
  }
  ...
  public editEntity(entity: any) {
    ...
    const dialogRef = this.dialog.open(EditSakila_film_actorComponent, {
