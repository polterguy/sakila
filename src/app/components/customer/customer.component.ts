...
import { EditCustomerComponent } from './modals/edit.customer.component';
...
export class CustomerComponent extends GridComponent implements OnInit {
  ...
  protected read(filter: any) {
    return this.httpService.customer.read(filter);
  }
  ...
  protected count(filter: any) {
    return this.httpService.customer.count(filter);
  }
  ...
  protected delete(ids: any) {
    return this.httpService.customer.delete(ids);
  }
  ...
  public ngOnInit() {
    ...
    this.create_date = this.createFormControl('create_date.eq');
