...
import { EditCityComponent } from './modals/edit.city.component';
...
export class CityComponent extends GridComponent implements OnInit {
  ...
  protected read(filter: any) {
    return this.httpService.city.read(filter);
  }
  ...
  protected count(filter: any) {
    return this.httpService.city.count(filter);
  }
  ...
  protected delete(ids: any) {
    return this.httpService.city.delete(ids);
  }
  ...
  public ngOnInit() {
    ...
    this.city = this.createFormControl('city.like');
    this.country_id = this.createFormControl('country_id.eq');
