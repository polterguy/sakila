...
import { EditSakila_storeComponent } from './modals/edit.sakila_store.component';
 ...
 */
@Component({
  selector: 'app-sakila_store',
  templateUrl: './sakila_store.component.html',
  styleUrls: ['./sakila_store.component.scss'],
  animations: [
...
export class Sakila_storeComponent extends GridComponent implements OnInit {
   ...
   */
  public url() {
    return 'magic/modules/sakila/store';
  }
  ...
  protected read(filter: any) {
    return this.httpService.sakila_store.read(filter);
  }
  ...
  protected count(filter: any) {
    return this.httpService.sakila_store.count(filter);
  }
  ...
  protected delete(ids: any) {
    return this.httpService.sakila_store.delete(ids);
  }
  ...
  public ngOnInit() {
    ...
    this.last_update = this.createFormControl('store.last_update.eq');
    this.store_id = this.createFormControl('store.store_id.eq');
    this.address_id = this.createFormControl('store.address_id.eq');
  }
  ...
  public editEntity(entity: any) {
    ...
    const dialogRef = this.dialog.open(EditSakila_storeComponent, {
