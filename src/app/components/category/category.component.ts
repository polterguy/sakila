...
import { EditCategoryComponent } from './modals/edit.category.component';
...
export class CategoryComponent extends GridComponent implements OnInit {
  ...
  protected read(filter: any) {
    return this.httpService.category.read(filter);
  }
  ...
  protected count(filter: any) {
    return this.httpService.category.count(filter);
  }
  ...
  protected delete(ids: any) {
    return this.httpService.category.delete(ids);
  }
