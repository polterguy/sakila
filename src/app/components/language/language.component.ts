...
import { EditLanguageComponent } from './modals/edit.language.component';
...
export class LanguageComponent extends GridComponent implements OnInit {
  ...
  protected read(filter: any) {
    return this.httpService.language.read(filter);
  }
  ...
  protected count(filter: any) {
    return this.httpService.language.count(filter);
  }
  ...
  protected delete(ids: any) {
    return this.httpService.language.delete(ids);
  }
  ...
  public ngOnInit() {
    ...
    this.name = this.createFormControl('name.like');
