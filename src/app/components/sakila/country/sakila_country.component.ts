...
import { EditSakila_countryComponent } from './modals/edit.sakila_country.component';
 ...
 */
@Component({
  selector: 'app-sakila_country',
  templateUrl: './sakila_country.component.html',
  styleUrls: ['./sakila_country.component.scss'],
  animations: [
...
export class Sakila_countryComponent extends GridComponent implements OnInit {
   ...
   */
  public url() {
    return 'magic/modules/sakila/country';
  }
  ...
  protected read(filter: any) {
    return this.httpService.sakila_country.read(filter);
  }
  ...
  protected count(filter: any) {
    return this.httpService.sakila_country.count(filter);
  }
  ...
  protected delete(ids: any) {
    return this.httpService.sakila_country.delete(ids);
  }
  ...
  public ngOnInit() {
     ...
     * on our columns.
     */
    this.country = this.createFormControl('country.country.like');
    this.last_update = this.createFormControl('country.last_update.eq');
    this.country_id = this.createFormControl('country.country_id.eq');
  }
  ...
  public editEntity(entity: any) {
    ...
    const dialogRef = this.dialog.open(EditSakila_countryComponent, {
