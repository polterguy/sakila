...
export class CustomerEditModalComponent {
   ...
   */
  private createColumns: string[] = ['store_id', 'first_name', 'last_name', 'email', 'address_id', 'active', 'create_date', 'last_update'];
  private updateColumns: string[] = ['customer_id', 'store_id', 'first_name', 'last_name', 'email', 'address_id', 'active', 'create_date', 'last_update'];
  ...
  save() {
    ...
    if (this.data.isEdit) {
      ...
      this.service.customerPut(this.data.entity).subscribe(res => {
      ...
      this.service.customerPost(this.data.entity).subscribe(res => {
        this.dialogRef.close(this.data.entity);
